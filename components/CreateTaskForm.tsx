...
export default function CreateTaskForm({
  ...
  const [selectedColumnId, setSelectedColumnId] = useState("Pending"); 

  function onSubmit({ task, description }: z.infer<typeof formSchema>) {

    if (!selectedColumnId) {
      // Puedes manejar el caso en el que no se ha seleccionado ninguna columna
      console.error("No se ha seleccionado ninguna columna");
      return;
    }
